...
if not ok_request_functionality or typeof(ok_request_functionality) ~= "function" then return getgenv().notify("Error", "This script will not work on this executor! (missing 'http_request').", 15) end
